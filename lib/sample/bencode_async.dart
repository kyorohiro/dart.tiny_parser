...
class BencodeAsync {
  ...
  static Future<Object> decode(Parser parser) {
...
class BdecoderAsync {
  ...
  Future<Object> decode(Parser parser) {
    return decodeBenObject(parser);
  }

  Future<Object> decodeBenObject(Parser parser) async {
  ...
  Future<Map> decodeDiction(Parser parser) async {
  ...
  Future<Map> decodeDictionElements(Parser parser) async {
    Map ret = new Map();
    while (true) {
  ...
  Future<List<Object>> decodeList(Parser parser) async {
  ...
  Future<List<Object>> decodeListElement(Parser parser) async {
  ...
  Future<int> decodeNumber(Parser parser) async {
  ...
  Future<String> decodeString(Parser parser) async {
    List<int> v = await decodeBytes(parser);
    return convert.UTF8.decode(v, allowMalformed: true);
  }

  Future<List<int>> decodeBytes(Parser parser) async {
